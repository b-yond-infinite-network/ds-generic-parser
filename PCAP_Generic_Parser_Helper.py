    ...
    for request in requests_list:
        ...
        for i in range(index+1,len(dataframe)):
            ...
            if(hasdiameter and msgtype=='0x00000040' and seq_n==request_seq_number and framenumber not in used_responses):
                ...
                try:
                    if((request_origin_host+' - Request - '+response_destination_host+ ' >>> ' + ' Response - '+response_origin_host+' - Result Code = '+diameter_result_code+' - '+response_destination_host) !=  output[-1]):
